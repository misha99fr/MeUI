...
local function doUnlock()
  graphics.drawInfo(
    "Загрузчик",
    {"ВНИМАНИЕ: Разблокировка СОТРЁТ все данные!", "Системные файлы устройства перестанут быть", "защищены от удаления и изменения.", "Это действие необратимо. Подтвердите паролем."}
  )
